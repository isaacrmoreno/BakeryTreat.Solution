...
namespace BakeryTreat.Migrations
{
    ...
    [Migration("20210604232623_ApplicationUserColumnToDatabase")]
    partial class ApplicationUserColumnToDatabase
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BakeryTreat.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("BakeryTreat.Models.FlavorTreat", b =>
                {
            ...
            modelBuilder.Entity("BakeryTreat.Models.FlavorTreat", b =>
                {
                    b.HasOne("BakeryTreat.Models.Flavor", "Flavor")
                        .WithMany("JoinEntities")
                        .HasForeignKey("FlavorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BakeryTreat.Models.Treat", "Treat")
                        .WithMany("JoinEntities")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BakeryTreat.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
